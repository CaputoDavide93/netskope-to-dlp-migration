# Netskope to DLP Migration Script# Netskope to DLP Migration Script# Netskope to DLP Migration Script# Netskope to DLP Migration Script# Netskope to DLP Migration Script# Netskope to DLP Migration Script# Netskope to Minecast Migration Script



Bash script that removes Netskope and installs any DLP solution on macOS via Jamf Pro.



## What It DoesA bash script for migrating macOS devices from Netskope to any DLP solution via Jamf Pro.



1. Removes all Netskope components (apps, extensions, configs)

2. Installs your target DLP via Jamf policy

3. Verifies the migration was successful## Features[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
...
- macOS 10.13+- Complete Netskope removal[![macOS](https://img.shields.io/badge/macOS-10.13+-brightgreen.svg)](https://www.apple.com/macos/)

- Jamf Pro

- Root access- Universal DLP support



## Usage- Automated installation via Jamf[![Jamf Pro](https://img.shields.io/badge/Jamf%20Pro-Compatible-blue.svg)](https://www.jamf.com/)[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)



```bash- Comprehensive logging
...
```bashA bash script for migrating macOS devices from Netskope to any DLP solution via Jamf Pro.[![macOS](https://img.shields.io/badge/macOS-10.13+-brightgreen.svg)](https://www.apple.com/macos/)
...
- Parameter 1: Jamf policy ID for your DLP installation- Root privileges

- Parameter 2: Log level (DEBUG, INFO, WARN, ERROR)
...
DLP_PATHS=(Clone the repository:

    "/Applications/YourDLP.app"

    "/Library/Application Support/YourDLP"- Universal DLP support (Code42, Mimecast, Forcepoint, or any DLP)
...
```git clone https://github.com/caputoDavide93/netskope-to-dlp-migration.git- Complete Netskope removal (apps, extensions, configs, user files)
...
- 0 = Success- Automated DLP installation via Jamf policyA bash script for migrating macOS devices from Netskope to any DLP solution via Jamf Pro.[![macOS](https://img.shields.io/badge/macOS-10.13+-brightgreen.svg)](https://www.apple.com/macos/)
...
2. Add the script- macOS 10.13 or later

3. Set Parameter 4 to your DLP policy ID (e.g., 269)

4. Set Parameter 5 to log level (INFO or DEBUG)- Jamf Pro environment
...
Edit the script to match your DLP:



```bash

DLP_PATHS=(## Installation- Complete Netskope removal (apps, extensions, configs, user files)
...
## Usage```bash- Comprehensive logging and health checks



Deploy via Jamf policy or test manually:git clone https://github.com/caputoDavide93/netskope-to-dlp-migration.git



```bashcd netskope-to-dlp-migration
...
## Exit Codes## Requirements



- 0 = Success**2. Upload to Jamf Pro**
...
**DLP not detected:** Verify policy ID and DLP_PATHS match your solution.

- Click **New** and upload `migrate_to_dlp.sh`- macOS 10.13+

**Netskope remains:** Some components need a reboot. Run again after restart.
...
pgrep -if netskope**3. Create Policy**

ls /Library/Launch{Daemons,Agents}/com.netskope.* 2>/dev/null

systemextensionsctl list | grep -i netskope- Root privileges
